...
global.attack_items = ds_grid_create(attack_items.total,attack_items_type.total);
var it = 0;
ds_grid_clear(global.attack_items,0)

while (it<ds_grid_width(global.attack_items))
{
	var banta = instance_create_layer(x+40+(24*it), y-48, "Instances_inventory" , obj_magic_slot_item)
	banta.var_slot = it;
